...
👨‍💻 Mainly a web development enthusiast, but I'm working on adding some variety to my coding palette.

🔗 **[Check out my portfolio (WIP)](https://begue.cc)**

You'll find here some personal and school projects I worked on 🌝
<br>
<br>
...
Football prediction game built with NodeJs, [Angular](https://angular.io/) and [Bulma](https://bulma.io/). Built as a PWA, powered by a Rest API, using the [football-data](https://www.football-data.org/) api and some web scraping to get its live data..
